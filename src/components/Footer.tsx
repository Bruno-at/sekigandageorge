      ...
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6 max-w-xs">
              Programmer & Web Developer based in Kampala, Uganda. Building digital solutions that make a difference.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-muted-foreground">
                ...
                <a href="mailto:bruno@sekigandageorge.com" className="hover:text-primary transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground text-center md:text-left">
            © {currentYear} SEKIGANDA GEORGE "BRUNO". All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground">
            Designed by <span className="text-primary font-medium">SEKIGANDA GEORGE "BRUNO"</span>
          </p>
        </div>
      </div>
    </footer>
